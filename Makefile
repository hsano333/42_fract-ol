...
SRCDIR	:= ./srcs/
SRC	:= init.c key.c mouse.c image.c julia.c mandelbrot.c gasket.c fract_common.c color.c color2.c image_common.c affine.c image_util.c zoom.c burning_ship.c arg.c
ENTRY	:= main.c
